...
sources[${#sources[@]}]='hyperledger/fabric hyperledger/fabric-amcl hyperledger/fabric-baseimage hyperledger/fabric-ca hyperledger/fabric-chaincode-evm hyperledger/fabric-chaincode-go hyperledger/fabric-chaincode-java hyperledger/fabric-chaincode-node hyperledger/fabric-chaintool hyperledger/fabric-cli hyperledger/fabric-config hyperledger/fabric-contract-api-go hyperledger/fabric-docs-i18n hyperledger/fabric-gateway-java hyperledger/fabric-lib-go hyperledger/fabric-protos-go hyperledger/fabric-protos hyperledger/fabric-rfcs hyperledger/fabric-samples hyperledger/fabric-sdk-go hyperledger/fabric-sdk-java hyperledger/fabric-sdk-node hyperledger/fabric-sdk-py hyperledger/fabric-test hyperledger/homebrew-fabric'
