...
projs[${#projs[@]}]='Zorow'
projs[${#projs[@]}]='OpenSwitch'
projs[${#projs[@]}]='PX4 Drone Autopilot'
projs[${#projs[@]}]='Automotive Grade Linux'
projs[${#projs[@]}]='IO Visor'
projs[${#projs[@]}]='MAVLink'
projs[${#projs[@]}]="Let's Encrypt"
projs[${#projs[@]}]='P4 Language'
projs[${#projs[@]}]='SPDX'
projs[${#projs[@]}]='FOSSology'
projs[${#projs[@]}]='RethinkDB'
projs[${#projs[@]}]='Core Infrastructure'
projs[${#projs[@]}]='Mininet'
declare -A sources
...
sources[${#sources[@]}]='open-switch/opx-tools open-switch/opx-pas open-switch/opx-sdi-sys open-switch/opx-platform-config open-switch/opx-nas-daemon open-switch/opx-nas-qos open-switch/opx-nas-l3 open-switch/opx-nas-l2 open-switch/opx-nas-multicast open-switch/opx-nas-interface open-switch/opx-nas-acl open-switch/opx-nas-linux open-switch/opx-nas-common open-switch/opx-sai-vm open-switch/opx-sai-api open-switch/opx-base-model open-switch/opx-cps open-switch/opx-common-utils open-switch/opx-onie-installer open-switch/opx-build open-switch/opx-test open-switch/opx-core open-switch/continuous-integration open-switch/opx-logging open-switch/ansible-role-opx-vlan open-switch/opx-docs open-switch/rootfs'
